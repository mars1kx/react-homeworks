...
const TrustpilotRating = styled.div`
  font-family: 'Inter', sans-serif;
  font-weight: 400;
  font-size: 16px;
  line-height: 20px;
...
const HomeHero = () => {
  return (
    <HeroContainer>
      <HeroContent>
        <HeroTitle>
          Beautiful food & takeaway, <Highlighted>delivered</Highlighted> to your door.
        </HeroTitle>
        <HeroDescription>
        ...
        <HeroCta>
          ...
          <Trustpilot>
            <TrustpilotLogo>
              <TrustpilotImage src={trustpilotLogo} alt="Trustpilot" />
            </TrustpilotLogo>
            <TrustpilotRating>
